...
from .models import User  # добавление модели пользователя
from django.core.files.storage import FileSystemStorage #для фото
from .forms import ImageForm #Для фото
